...
<div id="pages">
    <div id="pages-inside">
        <div id="pages-inside-cont">
            <?php icl_languages_switcher() ?>
			...
			if ($primaryNav == '') { ?>
				<ul id="<?php echo $menuID; ?>" class="<?php echo $menuClass; ?>">
					<?php if (get_option('puretype_home_link') == 'on') { ?>
						<li class="page_item"><a href="<?php bloginfo('url'); ?>" class="title" title="home again woohoo"><?php esc_html_e('Home','PureType') ?></a></li>
					<?php }; ?>
...
<div id="wrapper2" <?php global $fullwidth; if (is_page_template('page-full.php') || $fullwidth) echo (' class="no_sidebar"'); ?>>
	<div class="logo"> <span class="bluetitle"><a href="<?php echo home_url(); ?>"><?php echo esc_html(get_option('puretype_title_red')); ?></a></span><span class="redtitle"><a href="<?php echo home_url(); ?>"><?php echo esc_attr(get_option('puretype_title_blue')); ?></a></span> </div>
	<div class="slogan">
	...
	<div id="categories">
		...
		if ($secondaryNav == '') { ?>
			<ul class="<?php echo $menuClass; ?>">
				<?php show_custom_categories_menu($menuClass,false); ?>
			</ul> <!-- end ul.nav -->
		<?php }
