...
function custom_colors_css(){
	...
	<style type="text/css">
		...
		#wrapper2 { border:10px solid #<?php echo(get_option($shortname.'_color_bordercolor')); ?>; }
		.post-info { background-color: #<?php echo(get_option($shortname.'_postinfo1_bgcolor')); ?>; }
		.post-info2 { background-color: #<?php echo(get_option($shortname.'_postinfo2_bgcolor')); ?>; }
		a:link, a:visited { color: #<?php echo(get_option($shortname.'_color_mainlink')); ?>; }
		#pages .home a:link, #pages .home a:visited, #pages .current_page_item a:link, #pages .current_page_item a:visited, #pages ul li a:link, #pages ul li a:visited, #pages ul li a:active { color: #<?php echo(get_option($shortname.'_color_pagelink')); ?>; }
