                            ...
                            <div class="label"><?=__('Position','kontrolwp')?></div>
                             <div class="field">
                             		<select name="group-options[position]" class="rule-match">
                                    	<option value="normal" <?=isset($cf_group) && $cf_group->options['position'] == 'normal' ? 'selected="selected"':''?>><?=__('Standard','kontrolwp')?></option>
                                        <option value="advanced" <?=isset($cf_group) && $cf_group->options['position'] == 'advanced' ? 'selected="selected"':''?>><?=__('Advanced','kontrolwp')?></option>
                                        <option value="side" <?=isset($cf_group) && $cf_group->options['position'] == 'side' ? 'selected="selected"':''?>><?=__('Side','kontrolwp')?></option>
                                   	</select>
                             </div>
                    	</div>
                        <div class="item">
                            <div class="label"><?=__('Style','kontrolwp')?></div>
                             <div class="field">
                             		<select name="group-options[style]" class="rule-match">
                                        <option value="meta" <?=isset($cf_group) && $cf_group->options['style'] == 'meta' ? 'selected="selected"':''?>><?=__('In a Metabox','kontrolwp')?></option>
                                        <option value="none" <?=isset($cf_group) && $cf_group->options['style'] == 'none' ? 'selected="selected"':''?>><?=__('No Metabox','kontrolwp')?></option>
                                    </select>
                             </div>
                    	</div>
                  </div>
