...
- Bug Fix: Due to the way IE7/8 handle js objects, Internationalisation (i18n) caused javascript to break in Kontrol using IE 7/8. Fixed.
...
- Bug Fix: If an image was added, then removed, it would still pass the validation test as being added.
- Bug Fix: 'Add new row' button on repeatable fields was appearing if the rows exceeded the amount allowed, it does not now.
- Bug Fix: Developer shortcut for accessing field keys quickly in a horizontal format has been fixed.
